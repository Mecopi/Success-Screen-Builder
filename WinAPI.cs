...
namespace SuccessScreenBuilder
{
    public static class WinAPI
    {
        ...
        [DllImport("Kernel32.dll", CharSet= CharSet.Auto)] public static extern int TerminateThread(int hThread);
        #endregion
        #region Enum
        ...
        {
            SendMessage(Handle, WinAPI.WM_KEYDOWN, (byte)Key, 0);
            Thread.Sleep(10);
            SendMessage(Handle, WinAPI.WM_KEYUP, (byte)Key, 0);
        }
